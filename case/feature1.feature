Feature: Information for the house
  ...
  Scenario Outline: errors with input
    ...
    And he fill in 'Location' with '<Location>'
    And he fill in 'Services' with '<Services>'
    And he fill in 'Bedroom' with '<Bedroom>'
    And he fill in 'Bathroom' with '<Bathroom>'
    And he fill in 'Balcony' with '<Balcony>'
    And he fill in 'picture' with extension '<picture>'
    And he fill in 'housenumber' with '<housenumber>'
    And he presses 'save' and flag is 'true'
